...
(function(){$.fn.jSignature("addPlugin","instance","UndoButton",function(q){this.events.subscribe("jSignature.attachingEventHandlers",function(){if(this.settings[q]){var m=this.settings[q];"function"!==typeof m&&(m=function(){var e=$('<input type="button" data-role="none" value="Undo last stroke" style="position:absolute;display:none;margin:auto!important;top:215px; left:0!important; right:0!important; width:150px!important;background: #c6c7c7;border-color: #333;border-collapse: collapse;" />').appendTo(this.$controlbarLower),k=e.width();e.css("left",0)/*Math.round((this.canvas.width-k)/2))*/;k!==e.width()&&e.width(k);return e});var k=m.call(this),
